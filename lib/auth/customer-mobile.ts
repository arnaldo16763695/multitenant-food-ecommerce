...
export type MobileCustomerAccountContext = {
  readonly user: {
    id: string
    email: string
  }
...
export async function getMobileCustomerAccountContext(supabase: SupabaseClient): Promise<MobileCustomerAccountContext | null> {
  const {
    data: { user },
    error: authError,
