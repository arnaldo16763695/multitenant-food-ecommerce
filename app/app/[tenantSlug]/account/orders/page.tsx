        ...
        <section className="mx-auto w-full max-w-5xl rounded-2rem border border-stone-200 bg-white p-8 shadow-[0_12px_40px_rgba(28,25,23,0.07)]">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h1 className="mt-4 md:text-3xl text-2xl font-semibold tracking-tight text-stone-950">Historial y seguimiento de pedidos</h1>
            </div>
                  ...
                  <article key={order.id} className="rounded-1.5rem border border-stone-200 bg-stone-50/80 p-5">
                    <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                      ...
                      <div className="flex flex-wrap gap-2 text-sm">
                        ...
                        <span className="rounded-full bg-orange-100 px-3 py-1 font-semibold text-orange-700">{formatOrderStatus(order.status, order.fulfillmentType)}</span>
                      </div>
                    </div>
