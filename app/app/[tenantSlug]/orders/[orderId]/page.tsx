        ...
        {order ? (
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            <div className="rounded-[1.5rem] bg-stone-50 p-5 text-sm text-stone-600">
              ...
              <p className="mt-2">Estado: <span className="font-semibold text-stone-950">{order.status}</span></p>
            ...
            <div className="rounded-[1.5rem] bg-stone-50 p-5 text-sm leading-7 text-stone-600">
              El siguiente paso natural es conectar esta vista al historial del cliente y luego al seguimiento operativo desde kitchen.
            </div>
          </div>
        ) : (
          <p className="mt-4 text-sm leading-7 text-stone-600">No pudimos recuperar el detalle completo de la orden, pero el flujo de checkout ya está integrado.</p>
        )}
